...
export default function PdfEditor() {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            const overlayDataUrl = c.toDataURL({ format: 'png' });
            ...
            currPage.drawImage(overlayImage, {
                x: 0,
                y: 0,
                width: width,
                height: height,
        ...
        <div className="pdf-editor-container">
            ...
            <header className="editor-header">
                ...
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                    ...
                    <Button size="sm" onClick={handleDownload} isLoading={isProcessing} icon={<Download size={16} />}>
                        Done & Download
                    </Button>
                </div>
            </header>
